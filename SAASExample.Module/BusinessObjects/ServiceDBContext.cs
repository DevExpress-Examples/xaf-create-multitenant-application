...
public class ServiceDesignTimeDbContextFactory : IDesignTimeDbContextFactory<ServiceDBContext> {
    public ServiceDBContext CreateDbContext(string[] args) {
        ...
        //var optionsBuilder = new DbContextOptionsBuilder<SAASExample2EFCoreDbContext>();
        //optionsBuilder.UseSqlServer("Integrated Security=SSPI;Pooling=false;Data Source=(localdb)\\mssqllocaldb;Initial Catalog=SAASExample2");
        //optionsBuilder.UseChangeTrackingProxies();
        //optionsBuilder.UseObjectSpaceLinkProxies();
        //return new SAASExample2EFCoreDbContext(optionsBuilder.Options);
    }
}
...
public class ServiceDBContext : DbContext {
    ...
    public DbSet<SAASExtension.BusinessObjects.TenantObject> Tenants { get; set; }
