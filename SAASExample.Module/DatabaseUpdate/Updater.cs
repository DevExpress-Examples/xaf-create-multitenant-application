...
namespace SAASExample.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater {
...
#if !RELEASE
        if (ObjectSpace.IsKnownType(typeof(ApplicationUser))) {
    ...
    private PermissionPolicyRole CreateDefaultRole() {
        ...
        if(defaultRole == null) {
            ...
            defaultRole.AddTypePermissionsRecursively<ApplicationUser>(SecurityOperations.Read, SecurityPermissionState.Deny);
