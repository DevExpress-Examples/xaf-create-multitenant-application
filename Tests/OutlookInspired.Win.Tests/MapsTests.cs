...
namespace OutlookInspired.Win.Tests{
    ...
    public class MapsTests:TestBase{
        ...
        public async Task Employee(string user,string view,string viewVariant){
            await StartWinTest(user, application => application.AssertEmployeeMaps(view, viewVariant));
        }
        ...
        public async Task Customer(string user,string view,string viewVariant){
            await StartWinTest(user, application => application.AssertCustomerMaps(view, viewVariant));
        }
        ...
        public async Task Product(string user,string view,string viewVariant){
            await StartWinTest(user, application => application.AssertProductMaps(view, viewVariant));
        }
        ...
        public async Task Order(string user,string view,string viewVariant){
            await StartWinTest(user, application => application.AssertOrderMaps(view, viewVariant));
        }
        ...
        public async Task Opportunity(string user,string view,string viewVariant){
            await StartWinTest(user, application => application.AssertOpportunityMaps(view, viewVariant));
        }
    }
}