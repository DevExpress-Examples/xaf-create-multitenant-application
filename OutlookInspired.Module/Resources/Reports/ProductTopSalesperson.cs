...
namespace OutlookInspired.Module.Resources.Reports {
	public class ProductTopSalesperson : DevExpress.XtraReports.UI.XtraReport {
		...
		private void ProductTopSalesperson_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e) {
			if(Equals(true, paramAscending.Value)) {
				this.GroupHeader1.SortingSummary.SortOrder = DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending;
			} else {
				this.GroupHeader1.SortingSummary.SortOrder = DevExpress.XtraReports.UI.XRColumnSortOrder.Descending;
			}
		}
	}
}
