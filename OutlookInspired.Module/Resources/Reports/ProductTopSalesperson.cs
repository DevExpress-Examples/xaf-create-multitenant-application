...
namespace OutlookInspired.Module.Resources.Reports {
	public class ProductTopSalesperson : XtraReport {
		...
		private void InitializeComponent() {
			ComponentResourceManager resources = new ComponentResourceManager(typeof(ProductTopSalesperson));
			...
			XRGroupSortingSummary xrGroupSortingSummary1 = new XRGroupSortingSummary();
			...
			this.totals = new CalculatedField();
			...
			this.xrPictureBox4.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "ImageSource", "[Product].[Image]")});
			...
			// xrTable1
			// 
			this.xrTable1.LocationFloat = new PointFloat(9.536743E-05F, 207.3333F);
			...
			// xrTable8
			// 
			this.xrTable8.LocationFloat = new PointFloat(392.7134F, 274.8359F);
			...
			this.xrTable8.Rows.AddRange(new XRTableRow[] {
				...
				this.xrTableRow16,
				this.xrTableRow17});
			this.xrTable8.SizeF = new SizeF(238.9533F, 136.3069F);
			// 
			// xrTableRow12
			// 
			...
			// xrTable4
			// 
			this.xrTable4.LocationFloat = new PointFloat(0.3332933F, 475.4284F);
			this.xrTable4.Name = "xrTable4";
			this.xrTable4.Rows.AddRange(new XRTableRow[] {
				this.xrTableRow10});
			this.xrTable4.SizeF = new SizeF(641.6667F, 29.69642F);
			// 
			// xrTableRow10
			// 
			...
			this.xrTableCell3.Font = new DXFont("Segoe UI", 13F);
			this.xrTableCell3.ForeColor = Color.White;
			this.xrTableCell3.Name = "xrTableCell3";
			this.xrTableCell3.Padding = new PaddingInfo(8, 0, 0, 0, 100F);
			...
			// xrTableCell17
			// 
			this.xrTableCell17.BackColor = Color.FromArgb(((int)(((byte)(218)))), ((int)(((byte)(218)))), ((int)(((byte)(218)))));
			...
			this.xrChart1.LocationFloat = new PointFloat(10.00001F, 245.8359F);
			...
			this.xrChart1.SizeF = new SizeF(360.2291F, 205.039F);
			// 
			// paramAscending
			// 
			...
			// xrTable5
			// 
			this.xrTable5.LocationFloat = new PointFloat(169.1667F, 25F);
			...
			this.xrTable5.Rows.AddRange(new XRTableRow[] {
				...
				this.xrTableRow9,
				this.xrTableRow11});
			this.xrTable5.SizeF = new SizeF(462.5F, 195.0564F);
			...
			// xrTableCell6
			// 
			this.xrTableCell6.Font = new DXFont("Segoe UI", 22.25F);
			this.xrTableCell6.ForeColor = Color.FromArgb(((int)(((byte)(234)))), ((int)(((byte)(178)))), ((int)(((byte)(144)))));
			...
			this.xrTableRow18.Cells.AddRange(new XRTableCell[] {
				this.xrTableCell30,
				this.xrTableCell28});
			this.xrTableRow18.Font = new DXFont("Segoe UI", 14F);
			...
			this.xrTableCell28.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "sumSum([Total])")});
			this.xrTableCell28.Font = new DXFont("Segoe UI", 14F, DXFontStyle.Bold);
			...
			this.xrTableRow5.Cells.AddRange(new XRTableCell[] {
				this.xrTableCell10,
				this.xrTableCell11});
			this.xrTableRow5.Font = new DXFont("Segoe UI", 10F);
			this.xrTableRow5.ForeColor = Color.FromArgb(((int)(((byte)(127)))), ((int)(((byte)(127)))), ((int)(((byte)(127)))));
			...
			this.xrTableRow5.TextAlignment = TextAlignment.BottomLeft;
			...
			this.xrTableRow9.Cells.AddRange(new XRTableCell[] {
				this.xrTableCell24,
				this.xrTableCell25});
			this.xrTableRow9.ForeColor = Color.FromArgb(((int)(((byte)(127)))), ((int)(((byte)(127)))), ((int)(((byte)(127)))));
			...
			this.xrTableRow9.TextAlignment = TextAlignment.BottomLeft;
			...
			this.xrTableCell26.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "[Order.Employee.Email]")});
			...
			this.xrTableCell27.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "[Order.Employee.Skype]")});
			this.xrTableCell27.Name = "xrTableCell27";
			this.xrTableCell27.Weight = 1.5877035604940879D;
			// 
			// xrPictureBox1
			// 
			this.xrPictureBox1.BorderColor = Color.FromArgb(((int)(((byte)(127)))), ((int)(((byte)(127)))), ((int)(((byte)(127)))));
			this.xrPictureBox1.Borders = ((BorderSide)((((BorderSide.Left | BorderSide.Top) 
			                                             | BorderSide.Right) 
			                                            | BorderSide.Bottom)));
			this.xrPictureBox1.BorderWidth = 1F;
			this.xrPictureBox1.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "ImageSource", "[Order].[Employee].[Picture].[Data]")});
			this.xrPictureBox1.LocationFloat = new PointFloat(0F, 25F);
			this.xrPictureBox1.Name = "xrPictureBox1";
			this.xrPictureBox1.SizeF = new SizeF(158.7394F, 190.1483F);
			...
			this.GroupHeader1.GroupFields.AddRange(new GroupField[] {
				new GroupField("Order.Employee.Id", XRColumnSortOrder.Ascending)});
			...
			this.Parameters.AddRange(new Parameter[] {
				this.paramAscending});
			this.Version = "23.1";
			this.BeforePrint += new BeforePrintEventHandler(this.ProductTopSalesperson_BeforePrint);
