...
namespace OutlookInspired.Module.ModelUpdaters{
    public class NavigationItemsModelUpdater:ModelNodesGeneratorUpdater<NavigationItemNodeGenerator>{
        ...
        public const string ApplicationUserDetailView = "ApplicationUser_DetailView";
        ...
        public override void UpdateNode(ModelNode node){
            ...
            DashboardViews.Concat(WelcomeDetailView, ModelDifferenceListView, EvaluationListView,ApplicationUserDetailView,UserListView,RoleListView)
