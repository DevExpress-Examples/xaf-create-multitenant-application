...
namespace OutlookInspired.Module.Resources.Reports {
	public class SalesRevenueReport : XtraReport {
		...
		private void InitializeComponent() {
			...
			this.detailBand1.SortFields.AddRange(new GroupField[] {
				new GroupField("Order.InvoiceNumber", XRColumnSortOrder.Ascending)});
			// 
			// xrTable7
			// 
			...
			this.xrTableCell36.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "[Order.OrderDate]")});
			...
			this.xrTableCell37.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "[Order.InvoiceNumber]")});
			...
			this.xrTableCell38.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "[ProductUnits]")});
			...
			this.xrTableCell39.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "[ProductPrice]")});
			...
			this.xrTableCell40.ExpressionBindings.AddRange(new ExpressionBinding[] {
			...
			this.xrTableCell41.ExpressionBindings.AddRange(new ExpressionBinding[] {
			...
			this.ReportHeader.Controls.AddRange(new XRControl[] {
				...
				this.xrTable2,
				this.xrTable4});
			this.ReportHeader.Font = new DXFont("Arial", 9.75F);
			...
			// xrLabel1
			// 
			this.xrLabel1.Font = new DXFont("Arial", 16F);
			this.xrLabel1.LocationFloat = new PointFloat(83.34718F, 0F);
			this.xrLabel1.Name = "xrLabel1";
			this.xrLabel1.Padding = new PaddingInfo(2, 8, 0, 0, 100F);
			this.xrLabel1.SizeF = new SizeF(216.6667F, 39.08798F);
			...
			this.xrLabel9.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "[Order.OrderDate]")});
			this.xrLabel9.Font = new DXFont("Arial", 16F, DXFontStyle.Bold);
			this.xrLabel9.LocationFloat = new PointFloat(300.0139F, 0F);
			this.xrLabel9.Name = "xrLabel9";
			this.xrLabel9.Padding = new PaddingInfo(2, 2, 0, 0, 100F);
			this.xrLabel9.SizeF = new SizeF(216.6667F, 39.08798F);
			...
			// xrTable2
			// 
			this.xrTable2.LocationFloat = new PointFloat(1.589457E-05F, 61.6141F);
			this.xrTable2.Name = "xrTable2";
			this.xrTable2.Rows.AddRange(new XRTableRow[] {
				this.xrTableRow2,
				this.xrTableRow3});
			this.xrTable2.SizeF = new SizeF(402.0972F, 85.24207F);
			// 
			// xrTableRow2
			// 
			...
			// xrTableCell4
			// 
			this.xrTableCell4.Font = new DXFont("Arial", 12F);
			...
			this.xrTableCell7.Font = new DXFont("Arial", 12F, DXFontStyle.Bold);
			...
			// xrTableCell5
			// 
			this.xrTableCell5.Font = new DXFont("Arial", 12F);
			...
			this.xrTableCell8.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "sumSum([Discount])")});
			this.xrTableCell8.Font = new DXFont("Arial", 12F, DXFontStyle.Bold);
			...
			this.xrTable4.LocationFloat = new PointFloat(1.589457E-05F, 172.9167F);
			...
			this.GroupHeader1.GroupFields.AddRange(new GroupField[] {
				new GroupField("Product.Category", XRColumnSortOrder.Ascending)});
			...
			// xrLabel4
			// 
			this.xrLabel4.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "[Product.Category]")});
			this.xrLabel4.Font = new DXFont("Segoe UI", 12F, DXFontStyle.Bold);
			this.xrLabel4.LocationFloat = new PointFloat(0F, 4.000004F);
			...
			// xrTable6
			// 
			this.xrTable6.Borders = BorderSide.Bottom;
			this.xrTable6.Font = new DXFont("Segoe UI", 10F);
			this.xrTable6.LocationFloat = new PointFloat(1.589457E-05F, 60.00004F);
			...
			// xrTableCell30
			// 
			this.xrTableCell30.Font = new DXFont("Segoe UI", 10F, DXFontStyle.Bold);
			...
			// xrTableCell31
			// 
			this.xrTableCell31.Font = new DXFont("Segoe UI", 10F, DXFontStyle.Bold);
			...
			// xrTableCell32
			// 
			this.xrTableCell32.Font = new DXFont("Segoe UI", 10F, DXFontStyle.Bold);
			...
			// xrTableCell33
			// 
			this.xrTableCell33.Font = new DXFont("Segoe UI", 10F, DXFontStyle.Bold);
			...
			// xrTableCell34
			// 
			this.xrTableCell34.Font = new DXFont("Segoe UI", 10F, DXFontStyle.Bold);
			...
			// xrTableCell35
			// 
			this.xrTableCell35.Font = new DXFont("Segoe UI", 10F, DXFontStyle.Bold);
			...
			this.xrLabel5.ExpressionBindings.AddRange(new ExpressionBinding[] {
				new ExpressionBinding("BeforePrint", "Text", "sumCount([Product.Category])")});
			this.xrLabel5.Font = new DXFont("Segoe UI", 12F);
			this.xrLabel5.ForeColor = Color.FromArgb(((int)(((byte)(166)))), ((int)(((byte)(166)))), ((int)(((byte)(166)))));
			this.xrLabel5.LocationFloat = new PointFloat(449.6307F, 4.000004F);
			...
			this.xrLabel5.TextAlignment = TextAlignment.MiddleRight;
			...
			this.Margins = new DXMargins(100F, 100F, 119F, 93.37114F);
