...
namespace OutlookInspired.Module.Resources.Reports {
	public class SalesRevenueAnalysisReport : XtraReport {
		...
		private void InitializeComponent() {
			...
			this.xrChart1.LocationFloat = new PointFloat(0F, 37.375F);
			...
			// xrTable8
			// 
			this.xrTable8.LocationFloat = new PointFloat(407.0465F, 85.10419F);
			...
			this.xrTable8.Rows.AddRange(new XRTableRow[] {
				...
				this.xrTableRow14,
				this.xrTableRow15});
			this.xrTable8.SizeF = new SizeF(242.9535F, 125.3128F);
			// 
			// xrTableRow12
			// 
			...
			this.xrTableCell2.Font = new DXFont("Segoe UI", 11F);
			...
			this.xrTable4.LocationFloat = new PointFloat(0F, 301.0417F);
			...
			this.xrLabel5.LocationFloat = new PointFloat(449.6307F, 7.999992F);
