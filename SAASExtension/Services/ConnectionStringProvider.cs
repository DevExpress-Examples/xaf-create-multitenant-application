...
public class SimpleConnectionStringProvider : IConnectionStringProvider {
    readonly IConfigurationConnectionStringProvider provider;
    public SimpleConnectionStringProvider(ILogonParameterProvider logonParameterProvider, ITenantNamesHelper tenantNamesHelper, IConfigurationConnectionStringProvider provider) {
        this.provider = provider;
    }
    public string GetConnectionString() {
        return provider.GetConnectionString();
