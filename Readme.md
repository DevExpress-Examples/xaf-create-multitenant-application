<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/592224624/25.2.1%2B)
...
⛔ DEPRECATED. This repository was deprecated. In v25.2 and higher, the Outlook-Inspired Demo is installed as part of the XAF package. You can run the demo application from the Demo Center or examine the source code that is typically located in the following directory: %PUBLIC%\Documents\DevExpress Demos 25.2\Components\XAF\OutlookInspiredDemo.NET.EFCore\CS\.
