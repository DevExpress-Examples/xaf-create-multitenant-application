...
[OutlookInspired.Blazor.Server/Services/Internal/ApplicationBuilder.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Blazor.Server/Services/Internal/ApplicationBuilder.cs#L44):
...
[OutlookInspired.Win/Services/ApplicationBuilder.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Win/Services/ApplicationBuilder.cs#L79):
...
[OutlookInspired.Blazor.Server/Services/Internal/ApplicationBuilder.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Blazor.Server/Services/Internal/ApplicationBuilder.cs#L59):
...
[OutlookInspired.Win/Services/ApplicationBuilder.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Win/Services/ApplicationBuilder.cs#L69):
...
[OutlookInspired.Module/DatabaseUpdate/Updater.cs](https://github.com/EugeniyBurmistrov/How-to-create-a-multitenancy-application/blob/24.1.2%2B/CS/OutlookInspired.Module/DatabaseUpdate/Updater.cs#L36):
...
This folder serves as the centralized storage for app business logic so that all other class implementations can be compact. For instance, methods that utilize `XafApplication` are located in [Services/Internal/XafApplicationExtensions](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Module/Services/Internal/XafApplicationExtensions.cs):
...
Methods that use `IObjectSpace` can be found in [Services/Internal/ObjectSpaceExtensions](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Module/Services/Internal/ObjectSpaceExtensions.cs). For example:
...
[Services/Internal/ObjectSpaceExtensions](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Module/Services/Internal/SecurityExtensions.cs):
...
The [Attributes](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/tree/24.1.3%2B/CS/OutlookInspired.Module/Attributes) folder contains attribute declarations.
...
- `FontSizeDeltaAttribute`
  ...
  [OutlookInspired.Win/Editors/LabelControlPropertyEditor.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Win/Editors/LabelControlPropertyEditor.cs):
  ...
  [OutlookInspired.Win/Services/Internal/Extensions.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Win/Services/Internal/Extensions.cs):
  ...
  [OutlookInspired.Blazor.Server/Services/Internal/Extensions.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Blazor.Server/Services/Internal/Extensions.cs#L83):
...
- #### Appearance Subfolder
  ...
  [Attributes/Appearance/DeactivateActionAttribute.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Module/Attributes/Appearance/DeactivateActionAttribute.cs):
...
- #### Validation Subfolder 
  ...
  [Attributes/FontSizeDeltaAttribute.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Module/Attributes/FontSizeDeltaAttribute.cs):
...
- ##### CloneView Subfolder
  ...
  This subfolder contains the [CloneViewAttribute](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Module/Features/CloneView/CloneViewAttribute.cs) declaration, used to generate views (in addition to default views). For example:

  [BusinessObjects/Employee.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Module/BusinessObjects/Employee.cs#L22):
...
- `ChartListEditor` - An abstract list editor designed to create simple object-specific variants.
  ...
  [Editors/ChartListEditor.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Blazor.Server/Editors/ChartListEditor.cs):
...
- `ComponentPropertyEditor` - An abstract property editor that serves as a basis for editors such as `ProgressPropertyEditor` or `PdfViewEditor`. The latter uses the PdfViewer component from the _Components_ folder.
  ...
  [Editors/ComponentPropertyEditor.cs](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Blazor.Server/Editors/ComponentPropertyEditor.cs):
...
- #### Customers subfolder
  ...
  [Features/Customers/Stores/StoresCardView.razor](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Blazor.Server/Features/Customers/Stores/StoresCardView.razor):
...
- #### Employees subfolder
  ...
  [Features/Employees/CardView/CardView.razor](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Blazor.Server/Features/Employees/CardView/CardView.razor):
...
- #### Products subfolder
  ...
  [Features/Products/CardView.razor](https://github.com/DevExpress-Examples/xaf-create-multitenant-application/blob/24.1.3%2B/CS/OutlookInspired.Blazor.Server/Features/Products/CardView.razor):
