...
namespace OutlookInspired.Blazor.Server.Editors {
    ...
    public class ComponentPropertyEditor : BlazorPropertyEditorBase {
        ...
        protected virtual void RenderComponent(RenderTreeBuilder builder) => throw new NotImplementedException($"Subclass the {GetType().FullName} and  the {nameof(RenderComponent)} method to render your component");
    }
