...
namespace OutlookInspired.Win.Controllers.Maps{
    public class OpportunitiesWinMapsController:WinMapsViewController<Quote>{
        ...
        private VectorItemsLayer CreateItemsLayer(){
            var itemsLayer = new VectorItemsLayer(){
                Colorizer = new KeyColorColorizer{ ItemKeyProvider = new ArgumentItemKeyProvider() },
    ...
    public class OpportunitiesStageColorController:ViewController<DashboardView>{
        ...
        private void MapItActionOnExecuted(object sender, ActionBaseEventArgs e){
            var opportunitiesWinMapsController = Application.CreateController<OpportunitiesWinMapsController>();
